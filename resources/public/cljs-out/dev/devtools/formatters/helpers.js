...
var G__24055 = devtools.prefs.pref.call(null,v);
v = G__24055;
continue;
} else {
return v;
...
}catch (e24058){var _e__22868__auto__ = e24058;
return false;
}})();
...
}catch (e24062){var _e__22868__auto__ = e24062;
return false;
}})();
...
}catch (e24064){var _e__22868__auto__ = e24064;
return false;
}}
}
});
...
var vec__24066 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24066,(0),null);
var name = cljs.core.nth.call(null,vec__24066,(1),null);
...
return cljs.core.some.call(null,(function (p1__24069_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24069_SHARP_);
}),template);
});
