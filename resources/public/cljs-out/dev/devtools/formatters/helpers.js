...
var G__18832 = devtools.prefs.pref.call(null,v);
v = G__18832;
continue;
} else {
return v;
...
}catch (e18835){var _e__17846__auto__ = e18835;
return false;
}})();
...
}catch (e18839){var _e__17846__auto__ = e18839;
return false;
}})();
...
}catch (e18841){var _e__17846__auto__ = e18841;
return false;
}}
}
});
...
var vec__18843 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__18843,(0),null);
var name = cljs.core.nth.call(null,vec__18843,(1),null);
...
return cljs.core.some.call(null,(function (p1__18846_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18846_SHARP_);
}),template);
});
