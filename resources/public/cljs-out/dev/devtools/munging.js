...
var o18727 = temp__5455__auto__;
var temp__5455__auto____$1 = (o18727["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o18728 = temp__5455__auto____$1;
return (o18728["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__17839__auto__ = f;
return (o__17839__auto__["toString"]).call(o__17839__auto__);
} else {
return "";
}
}catch (e18729){var _ = e18729;
return "";
}});
...
try{var o__17839__auto___18731 = t;
(o__17839__auto___18731["cljs$lang$ctorPrWriter"]).call(o__17839__auto___18731,t,writer);
}catch (e18730){var __18732 = e18730;
}
...
var char_code = (function (){var o__17839__auto__ = (new String(char$));
return (o__17839__auto__["charCodeAt"]).call(o__17839__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__17839__auto__ = String;
return (o__17839__auto__["fromCharCode"]).call(o__17839__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18733 = num_code;
switch (G__18733) {
case (1):
return (185);
...
var o__17839__auto__ = String;
return (o__17839__auto__["fromCharCode"]).call(o__17839__auto__,superscript_code);
});
/**
...
}catch (e18735){var _e__17846__auto__ = e18735;
return false;
}})())){
...
var vec__18736 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__18736,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o18739 = temp__5455__auto__;
var temp__5455__auto____$1 = (o18739["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o18740 = temp__5455__auto____$1;
return (o18740["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___18747 = arguments.length;
var i__4731__auto___18748 = (0);
while(true){
if((i__4731__auto___18748 < len__4730__auto___18747)){
args__4736__auto__.push((arguments[i__4731__auto___18748]));

var G__18749 = (i__4731__auto___18748 + (1));
i__4731__auto___18748 = G__18749;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18743){
var vec__18744 = p__18743;
var ns_detector = cljs.core.nth.call(null,vec__18744,(0),null);
...
var G__18750 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__18751 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__18750;
remaining_tokens = G__18751;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18741){
var G__18742 = cljs.core.first.call(null,seq18741);
var seq18741__$1 = cljs.core.next.call(null,seq18741);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18742,seq18741__$1);
});
...
var vec__18755 = cljs.core.split_with.call(null,(function (p1__18754_SHARP_){
return cljs.core.not_EQ_.call(null,p1__18754_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__18755,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__18755,(1),null);
...
var vec__18761 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__18761,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__18761,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__18764 = cljs.core.rest.call(null,remaining_tokens);
var G__18765 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__18764;
name_tokens = G__18765;
continue;
} else {
...
var vec__18768 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__18768,(0),null);
var arity = cljs.core.nth.call(null,vec__18768,(1),null);
var vec__18771 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__18771,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__18771,(1),null);
var vec__18774 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__18774,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__18774,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__18774,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__18774,(3),null);
...
var vec__18780 = result;
var munged_ns = cljs.core.nth.call(null,vec__18780,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__18780,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__18780,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__18780,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__18780,(4),null);
var arity = cljs.core.nth.call(null,vec__18780,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__18784 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__18784,(0),null);
var args = cljs.core.nth.call(null,vec__18784,(1),null);
var vec__18787 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__18787,(0),null);
var name = cljs.core.nth.call(null,vec__18787,(1),null);
...
var G__18790 = (arity + (1));
var G__18791 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18792){
var vec__18793 = p__18792;
var arity = cljs.core.nth.call(null,vec__18793,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__18793,(1),null);
...
return cljs.core.get.call(null,arities,p1__18796_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__18797_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18800){
var vec__18801 = p__18800;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__18801,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18798){
var G__18799 = cljs.core.first.call(null,seq18798);
var seq18798__$1 = cljs.core.next.call(null,seq18798);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18799,seq18798__$1);
});
...
var map__18809 = options;
var map__18809__$1 = (((((!((map__18809 == null))))?(((((map__18809.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18809.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18809):map__18809);
var include_ns_QMARK_ = cljs.core.get.call(null,map__18809__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__18809__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__18809__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__18809__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18810 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__18810,(0),null);
var fn_name = cljs.core.nth.call(null,vec__18810,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__18810,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__18810,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__18810,(4),null);
var arity = cljs.core.nth.call(null,vec__18810,(5),null);
...
var o__17839__auto__ = f;
return (o__17839__auto__["getBasis"]).call(o__17839__auto__);
});
/**
...
}catch (e18814){var _e__17846__auto__ = e18814;
...
var G__18815 = (obj[cljs.core.first.call(null,path)]);
var G__18816 = cljs.core.rest.call(null,path);
obj = G__18815;
path = G__18816;
continue;
} else {
...
return (function (accum,p__18817){
var vec__18818 = p__18817;
var bit = cljs.core.nth.call(null,vec__18818,(0),null);
var protocol = cljs.core.nth.call(null,vec__18818,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18821){
var vec__18822 = p__18821;
var ns = cljs.core.nth.call(null,vec__18822,(0),null);
var name = cljs.core.nth.call(null,vec__18822,(1),null);
var selector = cljs.core.nth.call(null,vec__18822,(2),null);
...
return (function (p__18826){
var vec__18827 = p__18826;
var munged_name = cljs.core.nth.call(null,vec__18827,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__18827,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__18827,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__18825_SHARP_){
return (obj[cljs.core.first.call(null,p1__18825_SHARP_)]);
});})(name,sorted_matches,vec__18827,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
