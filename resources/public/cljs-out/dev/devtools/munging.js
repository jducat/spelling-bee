...
var o23932 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23932["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23933 = temp__5455__auto____$1;
return (o23933["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22861__auto__ = f;
return (o__22861__auto__["toString"]).call(o__22861__auto__);
} else {
return "";
}
}catch (e23934){var _ = e23934;
return "";
}});
...
try{var o__22861__auto___23936 = t;
(o__22861__auto___23936["cljs$lang$ctorPrWriter"]).call(o__22861__auto___23936,t,writer);
}catch (e23935){var __23937 = e23935;
}
...
var char_code = (function (){var o__22861__auto__ = (new String(char$));
return (o__22861__auto__["charCodeAt"]).call(o__22861__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22861__auto__ = String;
return (o__22861__auto__["fromCharCode"]).call(o__22861__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23938 = num_code;
switch (G__23938) {
case (1):
return (185);
...
var o__22861__auto__ = String;
return (o__22861__auto__["fromCharCode"]).call(o__22861__auto__,superscript_code);
});
/**
...
}catch (e23940){var _e__22868__auto__ = e23940;
return false;
}})())){
...
var vec__23941 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23941,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23944 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23944["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23945 = temp__5455__auto____$1;
return (o23945["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23948){
var vec__23949 = p__23948;
var ns_detector = cljs.core.nth.call(null,vec__23949,(0),null);
...
var G__23955 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23956 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23955;
remaining_tokens = G__23956;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23946){
...
var vec__23960 = cljs.core.split_with.call(null,(function (p1__23959_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23959_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23960,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23960,(1),null);
...
var vec__23966 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23966,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23966,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23969 = cljs.core.rest.call(null,remaining_tokens);
var G__23970 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23969;
name_tokens = G__23970;
continue;
} else {
...
var vec__23973 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23973,(0),null);
var arity = cljs.core.nth.call(null,vec__23973,(1),null);
var vec__23976 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23976,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23976,(1),null);
var vec__23979 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23979,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23979,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23979,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23979,(3),null);
...
var vec__23985 = result;
var munged_ns = cljs.core.nth.call(null,vec__23985,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23985,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23985,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23985,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23985,(4),null);
var arity = cljs.core.nth.call(null,vec__23985,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23989 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23989,(0),null);
var args = cljs.core.nth.call(null,vec__23989,(1),null);
var vec__23992 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23992,(0),null);
var name = cljs.core.nth.call(null,vec__23992,(1),null);
...
var G__23995 = (arity + (1));
var G__23996 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23997){
var vec__23998 = p__23997;
var arity = cljs.core.nth.call(null,vec__23998,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23998,(1),null);
...
return cljs.core.get.call(null,arities,p1__24001_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24002_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___24009 = arguments.length;
var i__4731__auto___24010 = (0);
while(true){
if((i__4731__auto___24010 < len__4730__auto___24009)){
args__4736__auto__.push((arguments[i__4731__auto___24010]));

var G__24011 = (i__4731__auto___24010 + (1));
i__4731__auto___24010 = G__24011;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24005){
var vec__24006 = p__24005;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24006,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24003){
var G__24004 = cljs.core.first.call(null,seq24003);
var seq24003__$1 = cljs.core.next.call(null,seq24003);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24004,seq24003__$1);
});
...
var map__24014 = options;
var map__24014__$1 = (((((!((map__24014 == null))))?(((((map__24014.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24014.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24014):map__24014);
var include_ns_QMARK_ = cljs.core.get.call(null,map__24014__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24014__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24014__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24014__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24015 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24015,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24015,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24015,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24015,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24015,(4),null);
var arity = cljs.core.nth.call(null,vec__24015,(5),null);
...
var o__22861__auto__ = f;
return (o__22861__auto__["getBasis"]).call(o__22861__auto__);
});
/**
...
}catch (e24019){var _e__22868__auto__ = e24019;
...
var G__24020 = (obj[cljs.core.first.call(null,path)]);
var G__24021 = cljs.core.rest.call(null,path);
obj = G__24020;
path = G__24021;
continue;
} else {
...
return (function (accum,p__24022){
var vec__24023 = p__24022;
var bit = cljs.core.nth.call(null,vec__24023,(0),null);
var protocol = cljs.core.nth.call(null,vec__24023,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24026){
var vec__24027 = p__24026;
var ns = cljs.core.nth.call(null,vec__24027,(0),null);
var name = cljs.core.nth.call(null,vec__24027,(1),null);
var selector = cljs.core.nth.call(null,vec__24027,(2),null);
...
return (function (p__24031){
var vec__24032 = p__24031;
var munged_name = cljs.core.nth.call(null,vec__24032,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24032,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24032,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24030_SHARP_){
return (obj[cljs.core.first.call(null,p1__24030_SHARP_)]);
});})(name,sorted_matches,vec__24032,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
