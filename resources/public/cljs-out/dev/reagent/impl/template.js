...
var G__18510 = o;
(G__18510[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__18514 = o;
(G__18514[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__18515__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__18515 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__18516__i = 0, G__18516__a = new Array(arguments.length -  0);
while (G__18516__i < G__18516__a.length) {G__18516__a[G__18516__i] = arguments[G__18516__i + 0]; ++G__18516__i;}
  args = new cljs.core.IndexedSeq(G__18516__a,0,null);
} 
...
var args = cljs.core.seq(arglist__18517);
...
var G__18519 = props;
var G__18519__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__18519,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18519);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__18519__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__18520){
...
var props = map__18521__$1;
var class$ = cljs.core.get.call(null,map__18521__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__18521,map__18521__$1,props,class$){
return (function (c){
...
});})(map__18521,map__18521__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__18523){
...
var on_write = cljs.core.get.call(null,map__18524__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__18524,map__18524__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__18524,map__18524__$1,on_write))
);
} else {
...
var G__18527 = jsprops;
(G__18527["defaultValue"] = value);

(G__18527["onChange"] = ((function (G__18527,v,value,on_change){
return (function (p1__18526_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18526_SHARP_);
});})(G__18527,v,value,on_change))
);
...
var vec__18530 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18530,(0),null);
var id = cljs.core.nth.call(null,vec__18530,(1),null);
var class$ = cljs.core.nth.call(null,vec__18530,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___18534 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___18534 == null)){
} else {
var key_18535 = temp__5461__auto___18534;
(jsprops["key"] = key_18535);
}
...
var temp__5461__auto___18536 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___18536 == null)){
} else {
var key_18537 = temp__5461__auto___18536;
reagent.impl.template.oset.call(null,jsprops,"key",key_18537);
}
...
var G__18538 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__18538["name"] = c);
...
var len__4730__auto___18544 = arguments.length;
var i__4731__auto___18545 = (0);
while(true){
if((i__4731__auto___18545 < len__4730__auto___18544)){
args__4736__auto__.push((arguments[i__4731__auto___18545]));

var G__18546 = (i__4731__auto___18545 + (1));
i__4731__auto___18545 = G__18546;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18542){
var G__18543 = cljs.core.first.call(null,seq18542);
var seq18542__$1 = cljs.core.next.call(null,seq18542);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18543,seq18542__$1);
});
...
break;
default:
var G__18549 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__18549;
continue;
...
var n__4607__auto___18551 = a.length;
var i_18552 = (0);
while(true){
if((i_18552 < n__4607__auto___18551)){
(a[i_18552] = reagent.impl.template.as_element.call(null,(a[i_18552])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___18554 = a.length;
var i_18555 = (0);
while(true){
if((i_18555 < n__4607__auto___18554)){
var val_18556 = (a[i_18555]);
if(((cljs.core.vector_QMARK_.call(null,val_18556)) && ((reagent.impl.template.key_from_vec.call(null,val_18556) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_18555] = reagent.impl.template.as_element.call(null,val_18556));
...
var ctx = ({});
var vec__18558 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__18558,(0),null);
var derefed = cljs.core.nth.call(null,vec__18558,(1),null);
...
var G__18561 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18561) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__18561){
