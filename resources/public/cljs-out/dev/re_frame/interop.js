...
return [(function (){var pred__10755 = cljs.core.instance_QMARK_;
var expr__10756 = reactive_val;
if(cljs.core.truth_(pred__10755.call(null,reagent.ratom.RAtom,expr__10756))){
return "ra";
} else {
if(cljs.core.truth_(pred__10755.call(null,reagent.ratom.RCursor,expr__10756))){
return "rc";
} else {
if(cljs.core.truth_(pred__10755.call(null,reagent.ratom.Reaction,expr__10756))){
return "rx";
} else {
if(cljs.core.truth_(pred__10755.call(null,reagent.ratom.Track,expr__10756))){
return "tr";
} else {
return "other";
}
